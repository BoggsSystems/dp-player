...
export class XchaneAuthenticationService {
  ...
  getCurrentXchaneUser() {
    ...
    return this.httpClient.get('/api/xchaneuser/me', httpOptions);
  }

  getXchaneUser(id: string) {
    console.log('In getCurrentXchaneUser');
    return this.httpClient.get('/api/xchaneuser/' + id, httpOptions);
  }

  // DO A VERSION OF THIS FOR THE "INTRODUCED" FLAG?
  // welcome() {
